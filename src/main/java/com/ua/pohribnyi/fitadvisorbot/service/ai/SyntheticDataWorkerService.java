...
/**
 * Transactional worker for processing synthetic data. This bean exists to
 * ensure that the @Transactional annotation is correctly applied when called
 * from an async event listener.
 */
@Service
@Slf4j
@RequiredArgsConstructor
public class SyntheticDataWorkerService {
	...
	public void processJobInTransaction(Long jobId) {
		...
		try {
			...
			eventPublisher.publishEvent(new JobProcessedEvent(this, jobId, JobStatus.PROCESSED));
